...
GoogleSignin.configure({
  ...
  accountHint: '', // specifies an account to preselect in the authorization UI. On Android, must be an account name. On iOS, can be an email address or a user's ID.
